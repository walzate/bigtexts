...
/**
 * UDF Pig que implementa el Named Entity Recognition en español
 *
 * @author Wilson Alzate Calderón <walzate@javeriana.edu.co>
 */
public class NER_ES extends EvalFunc<String> {
    ...
    public static AbstractSequenceClassifier<CoreLabel> getClassifier() {
        if (classifier == null) {
            try {
                ...
                Logger.getLogger(NER_ES.class.getName()).log(Level.SEVERE, null, ex);
