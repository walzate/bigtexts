...
public class StanfordRegexNER {
    ...
    public static void main(String args[]) {
        ...
        props.put("regexner.mapping", "RegexNerRules.txt");
        ...
        Annotation document = new Annotation("Se le administra al paciente 500 mg de acetaminofen y 300mg de ibuprofeno asi como tambien 500mg de Sinutab después de haber tomado Noxpirin.");
